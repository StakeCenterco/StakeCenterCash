...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StakeCenterCash Core StakeCenterCash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  StakeCenterCash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded StakeCenterCash transaction") + "\n" +
                               "  StakeCenterCash-tx [options] -create [commands]   " + _("Create hex-encoded StakeCenterCash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded StakeCenterCash transaction
