...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop StakeCenterCash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "StakeCenterCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* StakeCenterCash features */
        {"StakeCenterCash", "masternode", &masternode, true, true, false},
        {"StakeCenterCash", "listmasternodes", &listmasternodes, true, true, false},
        {"StakeCenterCash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"StakeCenterCash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"StakeCenterCash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"StakeCenterCash", "masternodedebug", &masternodedebug, true, true, false},
        {"StakeCenterCash", "startmasternode", &startmasternode, true, true, false},
        {"StakeCenterCash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"StakeCenterCash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"StakeCenterCash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"StakeCenterCash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"StakeCenterCash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"StakeCenterCash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"StakeCenterCash", "mnbudget", &mnbudget, true, true, false},
        {"StakeCenterCash", "preparebudget", &preparebudget, true, true, false},
        {"StakeCenterCash", "submitbudget", &submitbudget, true, true, false},
        {"StakeCenterCash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"StakeCenterCash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"StakeCenterCash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"StakeCenterCash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"StakeCenterCash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"StakeCenterCash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"StakeCenterCash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"StakeCenterCash", "checkbudgets", &checkbudgets, true, true, false},
        {"StakeCenterCash", "mnsync", &mnsync, true, true, false},
        {"StakeCenterCash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> StakeCenterCash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43211/\n";
}
