...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("StakeCenterCash Core"),
     ...
     * override -datadir in the StakeCenterCash.conf file in the default data directory
     * (to be consistent with StakeCenterCashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
