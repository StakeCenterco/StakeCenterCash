...
/** Utility functions used by the StakeCenterCash Qt UI.
 */
namespace GUIUtil
{
...
// Render STAKEC addresses in monospace font
...
// Parse "StakeCenterCash:" URI into recipient object, return true on successful parsing
