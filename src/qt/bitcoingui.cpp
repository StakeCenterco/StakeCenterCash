                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("StakeCenterCash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STAKEC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and StakeCenterCash: URIs)"));
  ...
  //  tabGroup->addAction(proposalAction);
   ...
   // connect(proposalAction, SIGNAL(triggered()), this, SLOT(gotoProposalPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About StakeCenterCash"), this);
    aboutAction->setStatusTip(tr("Show information about StakeCenterCash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for StakeCenterCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STAKEC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STAKEC addresses"));
    ...
    openAction->setStatusTip(tr("Open a StakeCenterCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the StakeCenterCash help message to get a list with possible StakeCenterCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("StakeCenterCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to StakeCenterCash network", "", count));
}
...
{
    QString strTitle = tr("StakeCenterCash"); // default title
    ...
    // Append title to "StakeCenterCash - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
