...
#   c) node1 mines 32 blocks, so now node 0 has 500000STAKEC, node 1 has 4250STAKEC, node2 has none.
#   d) node0 sends 601 STAKEC to node2, in two transactions (301 STAKEC, then 300 STAKEC).
