Contributing to StakeCenterCash Core
==================================

The StakeCenterCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the StakeCenterCash Core project, and is not to be
confused with overall StakeCenterCash Network Protocol consensus changes.

Whether a pull request is merged into StakeCenterCash Core rests with the project merge
...
Patches that change StakeCenterCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the StakeCenterCash consensus, it must have been
...
The project leader is the release manager for each StakeCenterCash Core release.
